...
require (
	...
	github.com/EdgeCDN-X/edgecdnx-geolookup v0.7.3
	github.com/EdgeCDN-X/edgecdnx-prefixlist v0.2.2
	github.com/EdgeCDN-X/edgecdnx-services v0.5.1
...
require (
	...
	github.com/EdgeCDN-X/edgecdnx-controller v0.17.0 // indirect
