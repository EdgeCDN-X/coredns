...
require (
	...
	github.com/EdgeCDN-X/edgecdnx-geolookup v0.7.0
	github.com/EdgeCDN-X/edgecdnx-prefixlist v0.2.0
	github.com/EdgeCDN-X/edgecdnx-services v0.3.0
...
require (
	...
	github.com/EdgeCDN-X/edgecdnx-controller v0.12.0 // indirect
